...
pr "Nobody ever really asked why, guess I'm not really the type people make chitchat with."
pr "What does surprise me is how very few people ever ask me what I'm doing"
...
pr "Funny, for all I've ever done, they only know about a select few things that think that's what I'm pouring all these years into, all their money into."
pr "They don't know jack shit, but they're still impressed."
pr "I don't really know what that means, if I'm some smart ass who pulls off miracles during his coffee break, the higher-ups know nothing about science, or that I just have the right approach..."
...
pr "Still, surprised no-one checks up on me too much. I guess just looking at the notes I make every once in a while on what I'm supposed to be doing makes them think I'm working harder than anyone here."
...
pr "When I'm bored or my brain is just a bit worn out, I work on what my paycheck says I do, cures for illnesses. Viruses. Whatever I feel like."
...
pr "Some may say the cures I come up with are insanely brilliant, that I'd have to be some crazy genius to even work them out, they wouldn't believe me if I told them I spent maybe 3 hours every Friday making them."
...
pr "Not even most of my team really knows why they're doing what they're doing, they get orders from me and they do them"
pr "Those who do think reach the \"dammit you get the job done\" thing, and they think management has the same ideas but is happy with it, so they keep quiet."
...
pr "...and the resulting changes, mutations, affect the organism's chances of yet again recreating itself."
pr "Spread this over billions of years and you get, well, all living shit."
pr "For humans, this process happens once ever 20 or so years. Viruses can do so in minutes."
...
pr "A medicine might kill 99.99\% of viruses, but that 1 in 10 billion retard virus babby with the genetic fuck-up that makes it immune to penicillin is gonna be the Adam of a new race."
pr "I decided to speed up this process by making each copy, each child, have a lot more changes than usual."
pr "Radiation tends to do the same but it just shreds the DNA leaving utter destruction."
pr "What I wanted is to affect every child, but not so drastically."
pr "I did this by using a organism of my own, a virus that lives on, or really just bonds to other viruses, changing their copies."
pr "Nice, non-destructive, doesn't really hurt the viruses. No need to re-engineer every bloody organism I want to work on, just shake and go"
...
"KNOCK KNCOK"
si "Sir, th-"
pr "Dammit girl, Can't you see I'm monologging to myself?"
...
pr "But you've never interrupted me like that before, I've never had the chance to say shit actively."
si "That's because you put HIV into the last guy who did that's sandwiches!"
pr "Well you're the cute secretary, you're supposed to do that stuff."
pr "Plus, that batch of HIV only turns into AIDS in people with a high Melanin count"
...
pr "What is it?"    
si "They're here to see you, Sir. It's important. With what's going on overseas, and now in Texas, your research is in the spotlight. They want to talk to you."
pr "Who are they?"
...
pr "That's crazy, it was a total fluke, I couldn't pull that off again."
bsg "I don't know for sure, but I have my suspicions. Would you mind if you showed us your work? We'd like to know how you made these things."
...
pr "My findings are based on the most fit cells that fight the issue, I reverse engineer them from there, compare the changes."
bsg "That's totally, utterly cheating and I love it. But how do you make so many permutations? That would take years, you've fixed things thrown at you in a couple of days! Small as they may have been, it was a greater accomplishment than anyone has managed before. How do you do this?"
pr "Well, I use something I created ages ago, it's a very basic thing that promotes changes in every single offspring, nothing too fancy, I found it by pot luck. But when I apply it to some of the more common cells in humans, expose the results to viruses the good cells literally just sit there, waiting for me to notice them"
...
pr "Oh, sorry. Umm, no. Not yet. Not recently, at least."
bsg "Could we run through it now? We have all day, and it's what the world needs right now."
...
bsg "The airborne what? What have you got over there?"
pr "Nothing! Umm, I-I'll get an Ebola sample."
...
"Me" "Could be vague, maybe this (And the following) are slowly remembers over the course of the 1st act?"
...
pr "What? Who are you?"
nur "I'm very familiar with your works. You have served me well."
...
nur "You will have dominion over your creation, as my daughters have dominion over their respective, well..."
